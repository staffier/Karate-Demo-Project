Feature: A simple server to demo some server-side Karate stuff...
  ...
  Background:
    ...
    * def response404 = { "message": "You're trying to reach an invalid link", "timestamp": "#(timestamp())" }
    ...
    * configure responseHeaders = { 'Content-Type': 'application/json', 'Response-ID': '#(uuid())' }
